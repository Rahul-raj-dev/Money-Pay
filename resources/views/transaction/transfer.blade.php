                    ...
                    <form action="/users/{{ $user->id }}/transfer" method="post">
                        ...
                        <div class="form-group">
                            <label for="receiver_id">receiver_id
                                ...
                                <input type="receiver_id" name="receiver_id" class="form-control"
                                    id="exampleInputreceiver_id" aria-describedby="receiver_idHelp"
                        ...
                        <div class="form-group">
                            <label for="amount">amount
                                ...
                                <input type="amount" name="amount" class="form-control" id="exampleInputamount"
